...
const ModalBar = ({ active, setActive }) => {
  return (
    <div className='w-screen h-screen overflow-y-hidden fixed top-0 left-0 bg-neutral-800/50 z-10 grid grid-cols-6'>
      <div className='h-screen col-span-5 bg-white'></div>
